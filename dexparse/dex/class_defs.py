...
class ClassDefs(object):
    ...
    def tostring(self):
        print('[DEBUG]:class_idx={} , access_flag = {} ,superclass_idx ={} '
              ...
              + 'class_data_off ={} , static_value_offset ={}'.format(hex(self.class_idx), hex(self.access_flag), hex(self.superclass_idx), hex(self.interface_offset),
                                                                      hex(self.source_file_idx), hex(
                                                                          self.class_data_off),
...
class DexClassDataHeader(object):
    ...
    def __init__(self):
        ...
        self.virtual_methods_size = 0  # uleb128


class ClassDataItem(object):

    """
    定义为class_data_item,成员大小采用uleb128编码格式
    """
